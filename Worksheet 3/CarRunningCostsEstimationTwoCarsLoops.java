public class CarRunningCostsEstimationTwoCarsLoops {
    public static void main(String[] args) {
        final double BUY_COST_CAR_1 = 12000;
        final double BUY_COST_CAR_2 = 18000;

        double distanceTraveled = 100000; // km
        ...
        while (distanceTraveled <= 100000000){
            ...
            if (totalCost2 < totalCost){
                System.out.println("Car 2 is cheaper to run than Car 1 at a total distance of " + distanceTraveled + "Km");
                break;
            }
            distanceTraveled = distanceTraveled + 100000;
        }
    }
}
