...
public class DemographicsOfEurope {
    public static void main(String[] args) {
        ...
        if (capital.equals("Andorra la Vella")) {
            population = "77,006";
            System.out.println(
                    capital + " is the capital of Andorra, which has a population of " + population + " people");
        } else if (capital.equals("Saint Helier")) {
            population = "97,857";
            System.out.println(
                    capital + " is the capital of Jersey, which has a population of " + population + " people");
        } else if (capital.equals("Vaduz")) {
            population = "37,910";
            System.out.println(
                    capital + " is the capital of Liechtenstein, which has a population of " + population + " people");
        } else if (capital.equals("Ljubljana")) {
