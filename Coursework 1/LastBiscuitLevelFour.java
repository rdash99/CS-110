...
public class LastBiscuitLevelFour {
    /*
    ...
    public static void main(final String[] args) {
        ...
        int numberTaken = 0;
        boolean legal = false;
        int userOneSkipped = 0;
        int userTwoSkipped = 0;
        boolean skip = false;
        boolean barrelLoop = true;
                ...
                if (!skip) {
                    ...
                    if (barrel.equals("both")) {
                        if (numberTaken
                                ...
                                && numberTaken
                                        > barrel2) {
                            System.out.println("Sorry, that's not a legal"
                                    + " number of "
                                    + "biscuits for that/those barrel(s)");
                            legal = false;
                            barrelLoop = true;
